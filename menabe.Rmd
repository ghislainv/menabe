---
title: "Reducing poverty might not fix the inceasing deforestation problem in Madagascar dry tropical forests"
...
#### Tropical forests and poverty in Madagascar

Tropical forests provide important ecosystem services at the global scale, such as biodiversity conservation and climate regulation [@Costanza1997] but also many at the regional scale for local populations. At the local scale, tropical forests supply clean water, can preserve populations from flood [@Bradshaw2007] and provide wood for construction and fuel and other non-woody products for food and health. On the island of Madagascar, three types of tropical forests, covering about 9 millions of hectares (15% of the country area) can be found: the moist forest in the East, the dry forest in the West and the spiny forest in the South [@Vieilledent2016]. Among all the ecosystem services cited previously, Malagasy forests are particularly important for the unique biodiversity they shelter, both in term of number of species and endemism in many taxonomic groups [@Goodman2005]. A large part of the original tropical forest is thought to have disappeared since the arrival of the humans on the island around 2000 years ago, some studies advancing that 90% of the island was originally covered by forest [@Burns2016]. Common narrative attributes the deforestation to the extreme poverty of the country and subsistence farming through slash-and-burn agriculture [@Scales2011, @Jarosz1993]. About 81% of the population leave below the international poverty line of 1.25$ per day in 2010 and more than 70% of the population of Madagascar, of 24 million people in 2015 [@WB2015], heavily rely on forests for their livelihood [@Anderson2006]. Moreover, Malagasy population is rapidly increasing, with population growing at a rate close to 3%.yr<sup>-1</sup>, thus doubling each 25 years.

#### Madagascar and international aid for the environment

Since the mid-1980s, much effort has been done to fight poverty and curb deforestation through implementing large rural development and biodiversity conservation programs. The donor community, led by the World Bank and the USAID has committed a tremendous investment into Malagasy conservation efforts. At $18 million per annum, the environment program of USAID Madagascar is the second largest American program in Madagascar, and one of the largest programs of its kind in the world. The World Bank further supported this environmental effort with an additional $180 million. Other bilateral donors including France (through the AFD, _"Agence Française de Développement"_ and the FFEM, _"Fond Français pour l'Environnement Mondial"_), Germany (through KFW, _"Kreditanstalt für Wiederaufbau"_) and others have funded specific project initiatives in coordination with the World Bank and the USAID. 

The USAID and the World Bank worked together with the Malagasy government in the late 1980s to try to find a way to reconcile these two difficult and seemingly mutually-exacerbating problems. The result of these discussions was the creation of the Malagasy Office of the Environment and the signing of a National Environmental Action Plan with three phases (PE-I, PE-II, PE-III). The 



As a newly created agency, ANGAP coordinated the management of 44 protected areas that included ten National Parks and 34 reserves using funds from USAID (Freudenberger, 2010).

The ANGAP 

Since 2003 and the decision taken by former president Marc Ravalomanana at the Durban World Park Congress to triple Madagascar's protected area coverage, the protected area network has increased from 1.7 million hectares to 6.4 million hectares (11% of the country area) by 2010, with the creation of 64 new protected areas and 22 temporary protected areas [@Aubert2013]. 

The delegators have mostly included the large environmental NGOs operating in Madagascar, including big international environmental NGOs such as the World Wide Fund for Nature (WWF), Conservation International (CI) and the Wildlife Conservation Society (WCS), as well as a number of smaller Malagasy and international conservation organisations.
...
Deforestation is still high nowadays with around 1'500'000 ha (a rate of around ) of the forest which has disappeared on the period 1990-2010 [@Harper2007, @Hansen2013].

...
We identified three causes of deforestation in the study area around the Kirindy-Mitea national park (Fig. 2b). Slash-and-burn agriculture for maize crops was identified as the main cause of deforestation in several areas at the periphery of the protected area (Fig. 2b, label A). Inside the protected area, uncontrolled fires were identified as the main cause of deforestation (Fig. 2b, label B). People repeatedly set fire on former grasslands (_"bozake"_) outside the protected area to obtain flush of green pasture for their livestock. When uncontrolled, fires can spread on large areas of the forest and cross the boundaries of the protected area. Illegal logging was also identify as a cause of deforestation in Kirindy-Mitea (Fig. 2b, label C). Timbers are mainly used for house and boat construction and sold in local markets in Belo-sur-Mer and Morondava. 

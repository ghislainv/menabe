...
(ref:cap-deforestation) **Historical deforestation on the period 2000-2010-2017 in the study areas around Menabe-Antimena New Protected Area (MANPA), Kirindy-Mite National Park (KMNP) and Mikea New Protected Area (MIKEA)**. Madagascar map is represented on the left panel (a), with Menabe-Antimena study area at the north, Kinrindy-Mitea study area in the middle, and Mikea study area at the south (black rectangles). On each of the sub-panels, the boundaries of the protected areas are represented with black polygones (source: Rebioma project at http://rebioma.net). Main roads are represented with thin black lines (source: FTM BD500). Coast line is represented with a thin grey line. Morondava and Belo-sur-Tsiribihina are the main cities located near MANPA. Belo-sur-Mer is the main village located near KMNP. Morombe is the mains village located near MIKEA. Green: forest cover in 2017, orange: 2000-2010 deforestation, red: 2010-2017 deforestation [@Vieilledent2018data]. In the study areas, the main cause of the deforestation is (A) the slash-and-burn agriculture (_"hatsake"_) for maize and peanut crops. The oter causes of deforestation are (B) cyclones followed by uncontrolled fires and (C) illegal logging. 

```{r deforestation, out.width="\\textwidth", fig.cap="(ref:cap-deforestation)"}
knitr::include_graphics("figures/deforestation.png")
```

(ref:cap-scenarios) **Projected deforestation on the period 2010-2050**. Green: projected forest cover in 2050, light brown: 2010-2050 deforestation following conservative scenario S1 (projecting 1990-2010 mean annual deforestation), dark brown: 2010-2050 additional deforestation following scenario S2 (projecting 2000-2017 mean annual deforestation). Most of the 2010-2017 deforestation observed on Fig. 2 is included in the 2010-2050 projections. We predicted a loss of 36-67% of the forest cover in 2050 compared to 2000 depending on the scenario. Most of the remaining forest will be concentrated inside protected areas.
